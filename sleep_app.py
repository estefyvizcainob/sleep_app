...
model = joblib.load('sleep_prediction_model.pkl')

# Set up the app title and header image
st.set_page_config(page_title="Sleep Quality Predictor", layout="wide")
st.title("🌙 Sleep Quality Predictor")
st.image("https://example.com/sleep-image.jpg", caption="Are you having a restful sleep?", use_column_width=True)
...
features = np.array([[age, university_year, sleep_duration, study_hours, screen_time,
